<template>
    <div id="group-page">
        ...
        <AddNewGroup :showDialog="showDialog" :adminColor="adminColor" :userGroups="groupData" :usersData="usersData" @add-group="addRow" @cancel-add-group="addRowCancle" />
        <GroupsList :adminColor="adminColor" :groupData="groupData" :usersData="usersData" :showHeader="showHeader" @edit-row="editRow" @save-row="saveRow" @remove-row="removeRow" />
    </div>
</template>
