<template>
    <div id="nav-bar-container" :class="adminColor">
        ...
        <nav class="side-nav">
            <ul class="nav-menu">
                <li @click="activatedList1()" class="nav-item li1"><font-awesome-icon class="listIcon1 iconList"
                        icon="fas fa-user-cog" /> User Management</li>
                <li class="nav-item li2 active select-list"><font-awesome-icon class="listIcon2 iconList"
            ...
            <div class="color-themes-container">
                <button :class="[adminColor === 'color1' ? 'primary-color1' : '']" class="color-theme-btn"
                    @click="$store.commit('setColorThemeAdmin', 'color1')">color1</button>
                <button :class="[adminColor === 'color2' ? 'primary-color2' : '']" class="color-theme-btn"
                    @click="$store.commit('setColorThemeAdmin', 'color2')">color2</button>
                <button :class="[adminColor === 'color3' ? 'primary-color3' : '']" class="color-theme-btn"
                    @click="$store.commit('setColorThemeAdmin', 'color3')">color3</button>
            </div>
        </nav>
    </div>
</template>
...
export default {
    ...
    methods: {
        ...
        openNavigation() {
            ...
            if (this.$store.state.adminColor === 'color1') listIcon2.style.color = "#d2cca1";
            if (this.$store.state.adminColor === 'color2') listIcon2.style.color = "#89BBFE";
            if (this.$store.state.adminColor === 'color3') listIcon2.style.color = "#20a8b7";
        },
        selectUser(user) {
            let destination;
            if (user.type === 'user') {
