    ...
    <div id="nav-bar-container" :class="adminColor">
        ...
        <nav class="side-nav">
            <ul class="nav-menu">
                ...
                <li class="nav-item li3 active select-list"><font-awesome-icon class="listIcon3 iconList"
...
export default {
    ...
    methods: {
        ...
        openNavigation() {
            ...
            if (this.$store.state.adminColor === 'color1') listIcon3.style.color = "#d2cca1";
            if (this.$store.state.adminColor === 'color2') listIcon3.style.color = "#89BBFE";
            if (this.$store.state.adminColor === 'color3') listIcon3.style.color = "#20a8b7";
        },
        selectUser(user) {
            let destination;
            if (user.type === 'user') {
