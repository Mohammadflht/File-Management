<template>
    <div id="wrapper">
        ...
        <AddNewUser :showDialog="showDialog" :adminColor="$store.state.adminColor" :userGroups="$store.state.groupData"
            :usersData="usersData" @add-user="addRow" @cancel-add-user="addRowCancle" />
        <UsersList :adminColor="adminColor" :userGroups="userGroups" :usersData="usersData" :showHeader="showHeader"
